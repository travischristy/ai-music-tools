      ...
      {blueprint && (
        <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-6">
                {includePrompts && blueprint.implementation.sunoPrompt && (
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="font-semibold text-lg">Suno AI Style Prompt</h3>
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText(blueprint.implementation.sunoPrompt);
                ...
                {includeMetatags && blueprint.implementation.metatags && (
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="font-semibold text-lg">Structural Metatags</h3>
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText(blueprint.implementation.metatags);
                          alert('Metatags copied to clipboard!');
                        }}
          ...
          <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">Export & Save</h2>
            <div className="grid md:grid-cols-3 gap-4">
              <button
                onClick={() => {
                  ...
                  downloadAnchorNode.setAttribute("download", "song-blueprint-full.json");
                  document.body.appendChild(downloadAnchorNode);
                  downloadAnchorNode.click();
                  downloadAnchorNode.remove();
                }}
                className="bg-gray-600 text-white px-4 py-3 rounded-lg hover:bg-gray-700 text-center"
              >
              ...
              <button
                onClick={() => {
                  const dataStr = "data:text/markdown;charset=utf-8," + encodeURIComponent(blueprint.exportReady);
                  const downloadAnchorNode = document.createElement('a');
                  downloadAnchorNode.setAttribute("href", dataStr);
                  downloadAnchorNode.setAttribute("download", "song-blueprint.md");
                  document.body.appendChild(downloadAnchorNode);
                  downloadAnchorNode.click();
                  downloadAnchorNode.remove();
                }}
              ...
              <button
                onClick={() => {
                  ...
                  printWindow.document.write(`
                    <html>
                      <head><title>Song Blueprint</title></head>
                      <body style="font-family: monospace; white-space: pre-wrap; padding: 20px;">
                        ${blueprint.exportReady}
                      </body>
                    </html>
                  `);
